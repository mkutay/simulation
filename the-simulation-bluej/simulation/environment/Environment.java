...
public class Environment {
  ...
  private int lastUpdateDay = 1; // The last day the weather was updated
  ...
  private final static double DAY_START = 1 / 3d; // Corresponds to 8am
  private final static double DAY_END =  0.8d + 1 / 30d; // Corresponds to 8pm


  /**
   * Constructor -- Creates a new environment with a random weather and wind direction.
   */
  public Environment() {
    setRandomWeather();
  ...
  /**
   * Updates the wind direction. Updates the current weather when the day changes.
   */
  ...
  /**
   * Updates the weather effects on the screen; that is, the lightning and rain effects.
  ...
  /**
   * Draws the screen effects -- the darkness effect.
   * @param display The display to draw the effects onto.
   */
