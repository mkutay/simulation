 ...
 */
public class Clock {
  private final double fps; // Frames per second to run the simulation at.
  private double lastTick; // To calculate the delta time.
  private double deltaTime; // Time between simulation steps in nanoseconds.
